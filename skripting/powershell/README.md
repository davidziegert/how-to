...
```powershell
# Wi‑Fi profiles including their passwords in plain text.
for /f "skip=9 tokens=1,2 delims=:" %i in ('netsh wlan show profiles') do netsh wlan show profile name="%j" key=clear
```